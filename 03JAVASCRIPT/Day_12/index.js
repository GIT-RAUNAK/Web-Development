//Notes: https://www.notion.so/Lecture-12-filter-set-reducer-map-and-set-2873a78e0e2280e192bfc88fa8d0bea7
...
// products.forEach((p,index)=>console.log(`-${index}-->${p.name}`))
// products.forEach((X,index)=>console.log(`${X.id}-->${X.name}-->${X.price-(0.3*X.price)}`))

// const productName= products.map(p=>[p.name,p.price])
// console.log(productName)

// const newArray=products.filter(p=>{ return p.price>600})
